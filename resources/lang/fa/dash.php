...
return [
    ...
    'messages' => [
        'success' => [
            ...
            'team' => [
                ...
                'offer' => [
                    'rejected' => 'با ریجکت کاربر شما به او یک فرصت دیگر برای تیم پیدا کردند دادید ;)' ,
                    'accepted' => 'کاربر با موفقیت به تیم شما اضافه گردید نوتیفیکیشنی برای کاربر ارسال گردید تا مطلع شود ;)'
                ]
            ]
        ...
        'error' => [
            ...
            'not_found_offer' => 'پیشنهادی برای مشاهده وجود ندارد'
        ]
    ] ,
    ...
    'team' => [
        ...
        'offers' => [
            'add' => 'چه کسانی را میتوانید به تیم خود اضافه کنید ؟',
            'add_label' => 'این افراد برای هم تیمی شدن با شما پیشنهاداتی داده اند شما میتوانید بهترین گزینه را انتخاب کنید و در <b>تیم</b> خود قرار دهید ' ,
            'mail' => [
                'subject' => 'شما عضو تیم ما شدی' ,
                'header' => 'یه تیمی شما رو به عنوان هم تیمی قبول کرده ' ,
            ] ,
            'show' => [
                "title" => "پیشنهاد :attributes" ,
                "desc"  => "نمایش پیشنهاد به تیم"
            ],
        ]
    ] ,
