...
return [
    ...
    "message" => [
        ...
        "success" => [
            ...
            "team" => [
                "create" => "تیم شما با موفقیت ساخته شده است."
            ]
        ] ,
        "error" => [
            "token_expired" => "توکن دسترسی منقضی گردیده است." ,
            "failure_create_team" => "حداکثر استفاده را از پلن خود نموده اید و دیگر نمیتوانید با این پلن تیمی بسازید."
        ]
    ],
    "pages" => [
        "dashboard" => [
