...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// Simple React Validator v1.0.2 | Created By Dockwa | MIT License | 2018
...
SimpleReactValidator = __webpack_require__(/*! simple-react-validator */ "./node_modules/simple-react-validator/dist/simple-react-validator.min.js");

__webpack_require__(/*! ./components/Particle */ "./resources/assets/auth/js/components/Particle.js");
...
__webpack_require__(/*! ./pages/Auth */ "./resources/assets/auth/js/pages/Auth.js");

/***/ }),

/***/ "./resources/assets/auth/js/components/Captcha.js":
/*!********************************************************!*\
  !*** ./resources/assets/auth/js/components/Captcha.js ***!
  \********************************************************/
...
function (_React$Component) {
  ...
  _createClass(Captcha, [{
    ...
    value: function reload() {
      ...
      var link = url.split("?");
      link = link[0] + "?".concat(this._randomInt());
      this.setState({
        url: link
      });
      NProgress.done();
...
/***/ "./resources/assets/auth/js/components/Particle.js":
/*!*********************************************************!*\
  !*** ./resources/assets/auth/js/components/Particle.js ***!
  \*********************************************************/
/*! exports provided: default */
...
if (document.getElementById('_particle')) {
  react_dom__WEBPACK_IMPORTED_MODULE_2___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Particle, null), document.getElementById('_particle'));
}

/***/ }),

/***/ "./resources/assets/auth/js/components/Spinner.js":
/*!********************************************************!*\
  !*** ./resources/assets/auth/js/components/Spinner.js ***!
  \********************************************************/
/*! exports provided: default */
...
/***/ "./resources/assets/auth/js/functions/core.js":
/*!****************************************************!*\
  !*** ./resources/assets/auth/js/functions/core.js ***!
  \****************************************************/
/*! exports provided: localHasItem, localGetItem, localSetItem, localRemoveItem, showMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "localHasItem", function() { return localHasItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "localGetItem", function() { return localGetItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "localSetItem", function() { return localSetItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "localRemoveItem", function() { return localRemoveItem; });
...
function showMessage(msg) {
  var onCloseFunc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  Snackbar.show({
    text: msg,
    pos: 'bottom-right',
    showAction: false,
...
/***/ "./resources/assets/auth/js/functions/profile.js":
/*!*******************************************************!*\
  !*** ./resources/assets/auth/js/functions/profile.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core */ "./resources/assets/auth/js/functions/core.js");
function _classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
...
function () {
  ...
  _createClass(Profile, null, [{
    key: "set",
    value: function set(code) {
      return Object(_core__WEBPACK_IMPORTED_MODULE_0__["localSetItem"])(profile__key, code);
    }
  }, {
    key: "check",
    value: function check() {
      return Object(_core__WEBPACK_IMPORTED_MODULE_0__["localHasItem"])(profile__key);
    }
  }, {
    key: "remove",
    value: function remove() {
      return Object(_core__WEBPACK_IMPORTED_MODULE_0__["localRemoveItem"])(profile__key);
    }
  }, {
    key: "get",
    value: function get() {
      return Object(_core__WEBPACK_IMPORTED_MODULE_0__["localGetItem"])(profile__key);
    }
  }]);
...
/***/ "./resources/assets/auth/js/pages/Auth.js":
/*!************************************************!*\
  !*** ./resources/assets/auth/js/pages/Auth.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _components_Captcha__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/Captcha */ "./resources/assets/auth/js/components/Captcha.js");
/* harmony import */ var _components_Spinner__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/Spinner */ "./resources/assets/auth/js/components/Spinner.js");
/* harmony import */ var _functions_profile__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../functions/profile */ "./resources/assets/auth/js/functions/profile.js");
/* harmony import */ var _functions_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../functions/core */ "./resources/assets/auth/js/functions/core.js");
function _typeof2(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof2 = function _typeof2(obj) { return typeof obj; }; } else { _typeof2 = function _typeof2(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof2(obj); }
...
function (_React$Component) {
  ...
  function Auth(props) {
    ...
    _this.fieldInput = _this.fieldInput.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(Auth, [{
    ...
    value: function submitForm(event) {
      ...
      if (this.validator.allValid()) {
        ...
        axios.post(propACTION, this.state.fields).then(function (response) {
          ...
          if (result.authunticate && result.msg) {
            ...
            _functions_profile__WEBPACK_IMPORTED_MODULE_4__["default"].set(result.authunticate);
            Object(_functions_core__WEBPACK_IMPORTED_MODULE_5__["showMessage"])(result.msg, function () {
              location.reload();
            });
          }
          ...
          if (error.response.data.message) {
            ...
            Object(_functions_core__WEBPACK_IMPORTED_MODULE_5__["showMessage"])(message, function () {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          propTYPE = _this$props.type,
          propFIELDS = _this$props.fields;
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, propFIELDS.map(function (field, key) {
        return _this3.fieldInput(field, key);
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        className: "btn btn-primary",
        onClick: this.submitForm
      }, this.state.loading ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Spinner__WEBPACK_IMPORTED_MODULE_3__["default"], {
        size: "14"
      }) : fields.submit[propTYPE]));
    }
  }, {
    key: "setFieldInput",
    value: function setFieldInput(event) {
      ...
      this.setState({
        fields: _objectSpread({}, this.state.fields, obj)
      });
    }
  }, {
    key: "fieldInput",
    value: function fieldInput(key) {
      var field = fields[key];
      var value = this.state['fields'][key];
      /*
      ...
      */
      ...
      if (field.type == "checkbox") {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          htmlFor: key
        }, field.label), this.validator.message(key, value, field.rule));
      }
      /*
      ...
      */
      ...
      if (field.type == "captcha") {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: key,
          className: "input-group form-group has-top-label mb-4"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "input-group-prepend"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "input-group-text"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Captcha__WEBPACK_IMPORTED_MODULE_2__["default"], null))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
          autoComplete: "off",
          name: key,
          className: "form-control",
          onChange: this.setFieldInput
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, field.label), this.validator.message(key, value, field.rule));
      }
      /*
      *  when text field
      */
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
        key: key,
        className: "form-group has-top-label mb-4"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: field.type,
        autoComplete: "off",
        name: key,
...
if (document.getElementById("_auth")) {
  var authForm = document.getElementById("_auth");
  var action = authForm.action;
  var type = authForm.getAttribute("data-type");

  var _fields;

  switch (type) {
    case "login":
      _fields = ['username', 'password', 'captcha', 'remember'];
      break;

    case "register":
      _fields = ['email', 'username', 'password', 'captcha', 'privacy'];
      break;
  }

  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Auth, {
    type: type,
    action: action,
    fields: _fields
  }), authForm);
...
/***/ 1:
/*!***********************************************!*\
  !*** multi ./resources/assets/auth/js/app.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
