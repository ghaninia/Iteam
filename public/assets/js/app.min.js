...
!function (n, e) {
   true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = e() : n.NProgress = e();
}(this, function () {
  var n,
      e,
      t = { version: "0.2.0" },
      r = t.settings = { minimum: .08, easing: "linear", positionUsing: "", speed: 200, trickle: !0, trickleSpeed: 200, showSpinner: !0, barSelector: '[role="bar"]', spinnerSelector: '[role="spinner"]', parent: "body", template: '<div class="bar" role="bar"><div class="peg"></div></div><div class="spinner" role="spinner"><div class="spinner-icon"></div></div>' };function i(n, e, t) {
    return n < e ? e : n > t ? t : n;
  }function s(n) {
    return 100 * (-1 + n);
  }t.configure = function (n) {
    var e, t;for (e in n) {
      void 0 !== (t = n[e]) && n.hasOwnProperty(e) && (r[e] = t);
    }return this;
  }, t.status = null, t.set = function (n) {
    var e = t.isStarted();n = i(n, r.minimum, 1), t.status = 1 === n ? null : n;var u = t.render(!e),
        c = u.querySelector(r.barSelector),
        l = r.speed,
        f = r.easing;return u.offsetWidth, o(function (e) {
      "" === r.positionUsing && (r.positionUsing = t.getPositioningCSS()), a(c, function (n, e, t) {
        var i;i = "translate3d" === r.positionUsing ? { transform: "translate3d(" + s(n) + "%,0,0)" } : "translate" === r.positionUsing ? { transform: "translate(" + s(n) + "%,0)" } : { "margin-left": s(n) + "%" };return i.transition = "all " + e + "ms " + t, i;
      }(n, l, f)), 1 === n ? (a(u, { transition: "none", opacity: 1 }), u.offsetWidth, setTimeout(function () {
    ...
    t.status || t.set(0);var n = function n() {
      setTimeout(function () {
    ...
    var e = t.status;return e ? e > 1 ? void 0 : ("number" != typeof n && (n = e >= 0 && e < .2 ? .1 : e >= .2 && e < .5 ? .04 : e >= .5 && e < .8 ? .02 : e >= .8 && e < .99 ? .005 : 0), e = i(e + n, 0, .994), t.set(e)) : t.start();
  }, t.trickle = function () {
    return t.inc();
    ...
    if (t.isRendered()) return document.getElementById("nprogress");c(document.documentElement, "nprogress-busy");var e = document.createElement("div");e.id = "nprogress", e.innerHTML = r.template;var i,
        o = e.querySelector(r.barSelector),
        u = n ? "-100" : s(t.status || 0),
        l = document.querySelector(r.parent);return a(o, { transition: "all 0 linear", transform: "translate3d(" + u + "%,0,0)" }), r.showSpinner || (i = e.querySelector(r.spinnerSelector)) && d(i), l != document.body && c(l, "nprogress-custom-parent"), l.appendChild(e), e;
  }, t.remove = function () {
    l(document.documentElement, "nprogress-busy"), l(document.querySelector(r.parent), "nprogress-custom-parent");var n = document.getElementById("nprogress");n && d(n);
    ...
    var n = ["Webkit", "O", "Moz", "ms"],
      ...
      return t = t.replace(/^-ms-/, "ms-").replace(/-([\da-z])/gi, function (n, e) {
        ...
        var t = document.body.style;if (e in t) return e;for (var r, i = n.length, s = e.charAt(0).toUpperCase() + e.slice(1); i--;) {
      ...
      var t,
          i,
          s = arguments;if (2 == s.length) for (t in e) {
        void 0 !== (i = e[t]) && e.hasOwnProperty(t) && r(n, t, i);
      } else r(n, s[1], s[2]);
    };
  }();function u(n, e) {
    return ("string" == typeof n ? n : f(n)).indexOf(" " + e + " ") >= 0;
  }function c(n, e) {
    var t = f(n),
        r = t + e;u(t, e) || (n.className = r.substring(1));
  }function l(n, e) {
    var t,
        r = f(n);u(n, e) && (t = r.replace(" " + e + " ", " "), n.className = t.substring(1, t.length - 1));
  }function f(n) {
...
!function (t) {
  ...
  function e(e) {
    ...
    this.options = i, this.validators = t.extend({}, a.VALIDATORS, i.custom), this.$element = t(r), this.$btn = t('button[type="submit"], input[type="submit"]').filter('[form="' + this.$element.attr("id") + '"]').add(this.$element.find('input[type="submit"], button[type="submit"]')), this.update(), this.$element.on("input.bs.validator change.bs.validator focusout.bs.validator", t.proxy(this.onInput, this)), this.$element.on("submit.bs.validator", t.proxy(this.onSubmit, this)), this.$element.on("reset.bs.validator", t.proxy(this.reset, this)), this.$element.find("[data-match]").each(function () {
      var r = t(this),
          a = r.attr("data-match");t(a).on("input.bs.validator", function () {
        e(r) && r.trigger("input.bs.validator");
      });
    }), this.$inputs.filter(function () {
      return e(t(this)) && !t(this).closest(".has-error").length;
    }).trigger("focusout"), this.$element.attr("novalidate", !0);
  };a.VERSION = "0.11.9", a.INPUT_SELECTOR = ':input:not([type="hidden"], [type="submit"], [type="reset"], button)', a.FOCUS_OFFSET = 20, a.DEFAULTS = { delay: 500, html: !1, disable: !0, focus: !0, custom: {}, errors: { match: "Does not match", minlength: "Not long enough" }, feedback: { success: "glyphicon-ok", error: "os-icon os-icon-close" } }, a.VALIDATORS = { native: function native(t) {
      var e = t[0];return e.checkValidity ? !e.checkValidity() && !e.validity.valid && (e.validationMessage || "error!") : void 0;
    }, match: function match(e) {
      var r = e.attr("data-match");return e.val() !== t(r).val() && a.DEFAULTS.errors.match;
    }, minlength: function minlength(t) {
      var e = t.attr("data-minlength");return t.val().length < e && a.DEFAULTS.errors.minlength;
    ...
    function a(t) {
      return a = t, r.attr("data-" + a + "-error") || ((e = r[0].validity).typeMismatch ? r.attr("data-type-error") : e.patternMismatch ? r.attr("data-pattern-error") : e.stepMismatch ? r.attr("data-step-error") : e.rangeOverflow ? r.attr("data-max-error") : e.rangeUnderflow ? r.attr("data-min-error") : e.valueMissing ? r.attr("data-required-error") : null) || r.attr("data-error");var e, a;
    }var i = [],
        o = t.Deferred();return r.data("bs.validator.deferred") && r.data("bs.validator.deferred").reject(), r.data("bs.validator.deferred", o), t.each(this.validators, t.proxy(function (t, o) {
      var s = null;!e(r) && !r.attr("required") || void 0 === r.attr("data-" + t) && "native" != t || !(s = o.call(this, r)) || (s = a(t) || s, !~i.indexOf(s) && i.push(s));
    }, this)), !i.length && e(r) && r.attr("data-remote") ? this.defer(r, function () {
      var s = {};s[r.attr("name")] = e(r), t.get(r.attr("data-remote"), s).fail(function (t, e, r) {
        i.push(a("remote") || r);
      }).always(function () {
        o.resolve(i);
      });
    ...
    var e = this;return t.when(this.$inputs.map(function () {
  ...
  "use strict";
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return t.Snackbar = n();
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = t.Snackbar = n() : t.Snackbar = n();
}(this, function () {
  var t = { current: null },
      n = { text: "Default Text", width: "auto", showAction: !1, showSecondButton: !1, secondButtonText: "", pos: "bottom-center", duration: 3e3, customClass: "", onActionClick: function onActionClick(t) {
      t.style.opacity = 0;
    }, onSecondButtonClick: function onSecondButtonClick(t) {}, onClose: function onClose(t) {} };t.show = function (o) {
    var c = e(!0, n, o);t.current && (t.current.style.opacity = 0, setTimeout(function () {
      var t = this.parentElement;t && t.removeChild(this);
    }.bind(t.current), 500)), t.snackbar = document.createElement("div"), t.snackbar.className = "snackbar-container " + c.customClass, t.snackbar.style.width = c.width;var a = document.createElement("p");if (a.style.margin = 0, a.style.padding = 0, a.style.color = c.textColor, a.style.fontSize = "inherit", a.style.fontWeight = 300, a.style.lineHeight = "1em", a.innerHTML = c.text, t.snackbar.appendChild(a), t.snackbar.style.background = c.backgroundColor, c.showSecondButton) {
      var r = document.createElement("button");r.className = "action", r.innerHTML = c.secondButtonText, r.style.color = c.secondButtonTextColor, r.addEventListener("click", function () {
        c.onSecondButtonClick(t.snackbar);
      }), t.snackbar.appendChild(r);
    }if (c.showAction) {
      var i = document.createElement("button");i.className = "action", i.innerHTML = c.actionText, i.style.color = c.actionTextColor, i.addEventListener("click", function () {
        c.onActionClick(t.snackbar);
      }), t.snackbar.appendChild(i);
    }c.duration && setTimeout(function () {
      t.current === this && (t.current.style.opacity = 0, t.current.style.top = "-100px", t.current.style.bottom = "-100px");
    }.bind(t.snackbar), c.duration), t.snackbar.addEventListener("transitionend", function (n, e) {
      "opacity" === n.propertyName && "0" === this.style.opacity && ("function" == typeof c.onClose && c.onClose(this), this.parentElement.removeChild(this), t.current === this && (t.current = null));
    }.bind(t.snackbar)), t.current = t.snackbar, document.body.appendChild(t.snackbar);getComputedStyle(t.snackbar).bottom, getComputedStyle(t.snackbar).top;t.snackbar.style.opacity = 1, t.snackbar.className = "snackbar-container " + c.customClass + " snackbar-pos " + c.pos;
  }, t.close = function () {
    ...
    var t = {},
        n = !1,
        e = 0,
        o = arguments.length;"[object Boolean]" === Object.prototype.toString.call(arguments[0]) && (n = arguments[0], e++);for (var c = function c(e) {
      for (var o in e) {
        Object.prototype.hasOwnProperty.call(e, o) && (n && "[object Object]" === Object.prototype.toString.call(e[o]) ? t[o] = extend(!0, t[o], e[o]) : t[o] = e[o]);
      }
    }; e < o; e++) {
      c(arguments[e]);
    }return t;
        ...
        if (!e.isDefaultPrevented()) {
            ...
            $.ajax({
                ...
                success: function success(response) {
                    if (response.status == true) Snackbar.show({
...
$(function () {
    $(".keywords-container").each(function () {
        ...
        function addKeyword(Input, response) {
            ...
            if ($.inArray(true, isValid) != -1) Snackbar.show({ text: "شما قبلا این آیتم را انتخاب نموده اید." });else {
                ...
                } else Snackbar.show({ text: "شما باید از لیست پیشنهادی انتخاب نمایید ." });
            }
            keywordInput.val("");
        }
        ...
        $.getJSON($(this).data('url')).done(function (response) {
            ...
            keywordInput.on('keyup', function (e) {
                var Input = $.trim(keywordInput.val());
                if (e.keyCode == 13) addKeyword(Input, response);
            });
        });
